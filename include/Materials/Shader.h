...
public:
	...
	void setVector3f(bool activated, const char* uniform, const glm::vec3& vec);
	void setVector4f(bool activated, const char* uniform, float x, float y, float z, float w);
	void setVector4f(bool activated, const char* uniform,const glm::vec4& vec);
	void setMat4(bool activated, const char* uniform, const glm::mat4& mat);
